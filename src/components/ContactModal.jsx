            ...
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-neutral-600 text-sm max-w-sm mx-auto leading-relaxed">
                  Thanks, <span className="font-bold text-neutral-900">{formData.name}</span>. I will review your project details and get back to you shortly.
                </p>
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    onClick={handleReset}
                    className="w-full sm:w-auto px-6 py-3 rounded-full bg-[#0c0c0c] text-white font-bold text-xs"
                  >
                    Close Window
                  </button>
                </div>
              ...
              <div>
                <div className="mb-6">
                  <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-neutral-100 text-neutral-800 text-xs font-mono font-bold mb-2">
                    BOOK A PROJECT
                  </div>
                  <h3 className="text-2xl font-display font-extrabold text-neutral-900">Get In Touch</h3>
                  <p className="text-xs sm:text-sm text-neutral-600 mt-1">Tell me about your product requirements and goals.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-2xl bg-neutral-50 border border-neutral-200 text-neutral-900 text-xs focus:outline-none focus:border-black focus:bg-white transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-2xl bg-neutral-50 border border-neutral-200 text-neutral-900 text-xs focus:outline-none focus:border-black focus:bg-white transition-all resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full py-3.5 rounded-full bg-[#0c0c0c] hover:bg-neutral-800 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md active:scale-98 transition-all"
                  >
