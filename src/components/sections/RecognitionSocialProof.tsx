    ...
    <section id="about" className="py-12 md:py-16">
      <div className="flex flex-col gap-6 max-w-[1140px] mx-auto px-6 my-10 md:my-16">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 md:p-8 rounded-[24px] bg-white border border-[#E7E7E5] shadow-[0_8px_30px_rgba(0,0,0,0.02)] transition-all duration-300 hover:border-[#D2D2CF] hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
        >
        ...
        >
          ...
          <blockquote className="text-xl sm:text-2xl md:text-[28px] font-normal text-[#111111] leading-relaxed tracking-[-0.02em] max-w-4xl">
            “TJ delivered a transformative design for our SaaS platform in record time. His attention to detail, motion craftsmanship, and strategic understanding took our conversion rate up by 42% in the first quarter.”
          </blockquote>
